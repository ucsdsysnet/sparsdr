...
average_detector::sptr average_detector::make()
{
    return gnuradio::get_initial_sptr(new average_detector_impl());
}
...
std::chrono::high_resolution_clock::time_point average_detector_impl::last_average()
{
    std::lock_guard<std::mutex> guard(d_last_average_mutex);
